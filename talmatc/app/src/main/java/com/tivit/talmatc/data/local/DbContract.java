...
public class DbContract {
    ...
    public static final class TB_USER {
        ...
        public static final String CREATE = CREATE_TABLE + TABLE_NAME  + " (" +
                KEY_ID              + TYPE_INT + "PRIMARY KEY AUTOINCREMENT" + COMMA_SPACE +
                KEY_USERNAME        + TYPE_TEXT + COMMA_SPACE +
                KEY_PASSWORD        + TYPE_TEXT + COMMA_SPACE +
                KEY_FULL_NAME       + TYPE_TEXT + COMMA_SPACE +
                KEY_ROLE            + TYPE_TEXT + COMMA_SPACE +
                KEY_UNIT            + TYPE_TEXT +
                ")";
    }
/*
    public static final class TB_ROLE {
    ...
    public static final class TB_USER_ROLE {
        ...
        public static final String CREATE = CREATE_TABLE + TABLE_NAME  + " (" +
                KEY_ID_USER            + TYPE_INT + COMMA_SPACE +
                KEY_ID_ROLE            + TYPE_INT +
                ")";
    }
    */
}
