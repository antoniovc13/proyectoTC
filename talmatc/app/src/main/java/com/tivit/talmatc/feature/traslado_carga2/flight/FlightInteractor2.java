...
public class FlightInteractor2 extends BaseInteractor implements FlightContract2.FlightInteractor {

    public FlightInteractor2() {
        super();
    }

    @Override
    public void saveTypeFlight(final FlightContract2.OnFlightListener onFlightListener, String codeFlight) {
    ...
    @Override
    public void onListPointInit(final FlightContract2.OnFlightListener onFlightListener) {
