...
public class ChargeMoveInteractor2 extends BaseInteractor implements ChargeMoveContract2.ChargeMoveInteractor {

    public ChargeMoveInteractor2() {
        super();
    }
...
*/
    ...
    @Override
    public void callLocalListFlight(final ChargeMoveContract2.OnChargeMoveListener onFlightListListener) {
    ...
    @Override
    public void callApiListFlightIni(final ChargeMoveContract2.OnChargeMoveListener onChargeMoveListener ) {
    ...
    @Override
    public void callLocalFindFlightByCode(final ChargeMoveContract2.OnChargeMoveListener onFlightListListener, String code) {
    ...
    @Override
    public void onListTractor(final ChargeMoveContract2.OnChargeMoveListener onChargeMoveListener) {
