...
public class FlightListAdapter2 extends RecyclerView.Adapter<FlightListAdapter2.FlightListViewHolder>
        implements ItemTouchHelperAdapter2 {

    private Callback mCallback;
    private List<Flight> mFlightResponseList;
    private String codeFlight;

    public FlightListAdapter2(List<Flight> mOrderResponseList, String codeFlight) {
